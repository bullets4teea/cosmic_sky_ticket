...
public class CalculatorMod implements ModInitializer, Command<ServerCommandSource> {

    @Override
    public void onInitialize() {
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            dispatcher.register(CommandManager.literal("calculator")
    ...
    private void sendFormattedResult(CommandContext<ServerCommandSource> context, String input, double result) {
        ...
        context.getSource().sendFeedback(
                () -> Text.literal("§6" + input + " §r= §a" + formatted),
                false
        );
    }

    private void sendError(CommandContext<ServerCommandSource> context, String message) {
